#Server Parameters
$Server = 1				# (1,2,3,4,5) 	DEFAULT: 3	Which Server to use. 														
...
$EnableVON = 1			# (0,1)			DEFAULT: 0	Enable in game VON channels (Side chat, command chat ect). Enable for non TFAR servers.		
...
$Enable3rdPerson  = 1	# (0,1)			DEFAULT: 0	Usually disabled on Ops, enabled on public server.								DEFAULT: 0
