...
if (_unitfaction in ["blu_f","blu_t_f","blu_ctrg_f"]) then {
	...
	["NATOCO",_hq, "CO", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["NATOOneSec",_hq, "1Sec", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["NATOTwoSec",_ifv, "2Sec", "ColorBlue"] spawn f_fnc_localGroupMarker;

	["NATOThreeSec",_hq, "3Sec", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["NATOX",_ft, "X", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["NATOX",_ft, "X", "ColorBlue"] spawn f_fnc_localGroupMarker;
	["NATOX",_ifv, "X", "ColorBlue"] spawn f_fnc_localGroupMarker;
