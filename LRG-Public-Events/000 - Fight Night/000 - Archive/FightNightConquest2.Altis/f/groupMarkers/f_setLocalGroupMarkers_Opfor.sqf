...
if (_unitfaction in ["opf_f","opf_t_f"]) then {
	["CSATCO",_hq, "CO", "ColorRed"] spawn f_fnc_localGroupMarker;
	["CSATOneSec",_hq, "1Sec", "ColorRed"] spawn f_fnc_localGroupMarker;
	["CSATTwoSec",_ifv, "2Sec", "ColorRed"] spawn f_fnc_localGroupMarker;

	["CSATThreeSec",_hq, "3Sec", "ColorRed"] spawn f_fnc_localGroupMarker;
	["CSATX",_ft, "X", "ColorRed"] spawn f_fnc_localGroupMarker;
	["CSATX",_ft, "X", "ColorRed"] spawn f_fnc_localGroupMarker;
	["CSATX",_ifv, "X", "ColorRed"] spawn f_fnc_localGroupMarker;
