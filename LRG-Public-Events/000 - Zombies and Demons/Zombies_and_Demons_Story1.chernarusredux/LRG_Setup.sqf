...
DynamicWeather = 	False;						// Random Weather. True to enable, false to disable. 				DEFAULT: True

//================= Safe Zone
safezoneEnabled = 	False; 						// No shooting at base. True is ON, false is OFF. 					Default: True
...
//================= Arsenal
EnableArsenal = 	False;						// Enable Default LRG Arsenal. True to enable, false to disable. 	DEFAULT: True.
...
TimedArsenal = 		False;						// Remove the Arsenal after 'ArsenalExpiry'.						DEFAULT: True
ArsenalExpiry = 	50;							// How long in minutes from server start to remove the Arsenal. 	DEFAULT: 50
ArsenalLoadSave = 	False;						// Allow Load/Save in the Arsenal/AmmoBox. 							DEFAULT: False

//================= Ammo Boxes
EnableAmmoBox = 	False;						// Enable predefined Ammo box based on ArsenalType. 				DEFAULT: True
...
EnableLRGMedFacility = False;					// Enable use of auto heal/revive at Med Facilities.	DEFAULT: True
...
Confirmation =		True;						// Set to TRUE!!! 										DEFAULT: False.
