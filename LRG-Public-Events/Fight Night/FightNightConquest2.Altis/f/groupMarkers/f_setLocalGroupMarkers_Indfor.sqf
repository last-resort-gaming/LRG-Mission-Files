...
if (_unitfaction in ["ind_f"]) then {
	["AAFCO",_hq, "CO", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["AAFOneSec",_hq, "1Sec", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["AAFTwoSec",_ifv, "2Sec", "ColorGreen"] spawn f_fnc_localGroupMarker;

	["AAFThreeSec",_hq, "3Sec", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["AAFX",_ft, "X", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["AAFX",_ft, "X", "ColorGreen"] spawn f_fnc_localGroupMarker;
	["AAFX",_ifv, "X", "ColorGreen"] spawn f_fnc_localGroupMarker;
