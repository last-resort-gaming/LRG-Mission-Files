...
// INDEPENDENT AAF FACTION	
	if (_faction==2) then {
	_InfPool=	["I_Survivor_F"];	
	_ArmPool=	[];
	_MotPool=	["C_Offroad_02_unarmed_F","C_Offroad_01_F","CUP_C_Skoda_Blue_CIV","CUP_C_Golf4_random_Civ","C_Van_01_transport_F","CUP_C_Skoda_Green_CIV","C_Offroad_02_unarmed_F","C_IDAP_Van_02_medevac_F","CUP_C_Datsun_4seat","CUP_C_Skoda_White_CIV","CUP_C_V3S_Open_TKC","CUP_C_Golf4_random_Civ","C_IDAP_Offroad_02_unarmed_F","C_Van_02_transport_F"];
	_ACHPool=	[];
	_CHPool=	[];
	_uavPool=	[];
	_stPool=	[];
...
// ADD CLASSNAMES 
	if (_faction==5) then {
	_InfPool=	["O_Soldier_F"];	
	_ArmPool=	["CUP_O_BRDM2_RUS","CUP_O_GAZ_Vodnik_BPPU_RU"];
	_MotPool=	["CUP_O_UAZ_MG_RU","CUP_O_UAZ_Open_RU","CUP_O_UAZ_AGS30_RU","CUP_O_UAZ_AGS30_TKA","CUP_O_UAZ_MG_TKA","CUP_O_UAZ_Open_TKA","O_G_Offroad_01_armed_F","CUP_O_UAZ_SPG9_RU"];
	_ACHPool=	[];
	_CHPool=	[];
	_uavPool=	[];
	_stPool=	["CUP_O_DSHKM_SLA","CUP_O_SPG9_SLA","CUP_O_AGS_SLA"];
	_shipPool=	[];
	_diverPool=	[];
	_crewPool=	["O_Soldier_F"];
	_heliCrew=	[];
	};
