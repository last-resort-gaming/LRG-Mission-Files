...
blackListTowns = ["Moray","Arudy"];// Remove towns from COS

whiteListMkrs=["town_01","town_02","town_03","town_04","town_05","town_06","town_07","town_08","town_09","town_10","town_11","town_12","town_13","town_14","town_15"];// Add Custom Markers for COS to populate 

DefaultSide = independent;// Set side of units spawned
...
_rad=100;// Radius increase increment for finding minimum spawn points
