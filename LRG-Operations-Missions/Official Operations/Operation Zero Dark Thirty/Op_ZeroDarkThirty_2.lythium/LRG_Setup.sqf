...
safezoneDistance = 	250; 						// No shooting at base distance in meters. 							Default: 150m.
...
ArsenalName = 		["Box1","Box2"];					// Variable Name of Arsenal.										DEFAULT: "Box1"
...
AmmoBoxName = 		["Ammo1","Ammo2","Ammo3"];			// Variable Name of Ammo Boxes.										DEAFULT: "Ammo1","Ammo2"
...
LRFrequency_2 = 	"42.5";						// Command Net. Range: 30 - 87MHz						DEFAULT: "40"
LRFrequency_3 = 	"56.5";						// Pilot Net. 	Range: 30 - 87MHz						DEFAULT: "50"
