...
// EAST RUSSIA VDV FACTION 	
	if (_faction==6) then {
	_InfPool=	["rhs_vdv_mflora_efreitor","rhs_vdv_mflora_engineer","rhs_vdv_mflora_grenadier_rpg","rhs_vdv_mflora_grenadier","rhs_vdv_mflora_machinegunner","rhs_vdv_mflora_at","rhs_vdv_mflora_medic","rhs_vdv_mflora_rifleman","rhs_vdv_mflora_sergeant","rhs_vdv_mflora_strelok_rpg_assist","rhs_vdv_mflora_junior_sergeant"];	
...
// EAST RUSSIA SPETSNAZ FACTION	
	if (_faction==7) then {
	_InfPool=	["CUP_O_RUS_Commander","CUP_O_RUS_Saboteur","CUP_O_RUS_Soldier_GL","CUP_O_RUS_Soldier_TL","CUP_O_RUS_SpecOps_Scout","CUP_O_RUS_SpecOps","CUP_O_RUS_Soldier_Marksman"];	
