-	/*
	...
	*/
	...
	_startingdate = [2017, 07, 01, 06, 30];

	// Mission starting weather "CLEAR 50%|CLOUDY 33%|RAIN 0,16%";
	_startingweather = ["CLEAR", "CLEAR", "CLEAR", "CLOUDY", "CLOUDY", "RAIN"] call BIS_fnc_selectRandom;
	...
	[_realtime, _timesync, _daytimeratio, _nighttimeratio] spawn {
		...
		_nighttimeratio =  _this select 1;
