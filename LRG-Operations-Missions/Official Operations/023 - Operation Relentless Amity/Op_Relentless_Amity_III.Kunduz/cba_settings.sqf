...
force ace_medical_litterCleanUpDelay = 60;
...
force ace_medical_menu_maxRange = 6.03832;
...
force ace_medical_playerDamageThreshold = 2.0;
...
force LRG_Channels_Master = true;
...
force LRG_Main_Master = true;
force LRG_Main_PilotCheck = true;
force LRG_Main_QSMagRepack = false;
force LRG_Main_TFARTerrainInterference = 0.7;
...
// LRG QS Icons
force LRG_QSIcons_GPS_EnableUnitIcons = true;
force LRG_QSIcons_GPS_GroupOnly = false;
force LRG_QSIcons_GPS_Range = 300;
force LRG_QSIcons_GPS_ShowNames = false;
force LRG_QSIcons_Group_HUD = false;
force LRG_QSIcons_Group_Icons = false;
force LRG_QSIcons_Group_Map = true;
force LRG_QSIcons_Group_Only = false;
force LRG_QSIcons_IconColor_Civilian = [0.4,0,0.5,0.65];
force LRG_QSIcons_IconColor_East = [0.5,0,0,0.65];
force LRG_QSIcons_IconColor_Medical = [1,0.41,0,1];
force LRG_QSIcons_IconColor_Resistance = [0,0.5,0,0.65];
force LRG_QSIcons_IconColor_Unknown = [0.7,0.6,0,0.5];
force LRG_QSIcons_IconColor_West = [0,0.3,0.6,0.65];
force LRG_QSIcons_IconColor_Wounded = [0.75,0.55,0,0.75];
force LRG_QSIcons_IconTextFonts = 0;
force LRG_QSIcons_Map_AINames = false;
force LRG_QSIcons_Map_Delay = 1;
force LRG_QSIcons_Map_EnableUnitIcons = true;
force LRG_QSIcons_Map_FactionOnly = true;
force LRG_QSIcons_MasterEnable = true;
force LRG_QSIcons_MedicalSystem = 3;
force LRG_QSIcons_ShowAI = false;
