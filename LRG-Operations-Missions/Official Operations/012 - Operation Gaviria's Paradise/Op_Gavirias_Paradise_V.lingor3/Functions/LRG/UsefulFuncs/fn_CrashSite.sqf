// ["init", [CrashPlane, getPos crashSite]] call LR_fnc_crashSite;
...
switch (_stage) do {
     ...
     * // in initPlayerLocal...
     * 
     * player setVariable ["ownerID",ownerID,true];
     * 
     * // later
     * ... remoteExec [...,_x getVariable "ownerID"];
     */

	{
//			["","BLACK OUT", 5] remoteExec ["cutText", _x];
