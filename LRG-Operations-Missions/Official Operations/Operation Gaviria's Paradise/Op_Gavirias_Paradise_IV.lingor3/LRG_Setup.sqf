...
safezoneArea = 	60; 							// Default: 150m					No shooting at base distance in meters².
...
AmmoBoxName = 		["Ammo1", "Ammo2", "Ammo3"];			// DEAFULT: "Ammo1", "Ammo2"		Variable Name of Ammo Boxes.

//================= Dynamic Weather
EnableDynamicWeather = 	False;					// DEFAULT: True					Random Weather. True to enable, false to disable.
StartingWeather = "CLEAR";						// DEFAULT: "RANDOM"				Can be "CLEAR", "CLOUDY", "RAIN" or "RANDOM".
...
Confirmation =		True;						// DEFAULT: False					Set to True!!!
