...
force LRG_AI_AimingShake = 0.5;

force LRG_AI_AimingSpeed = 0.25;
...
force LRG_AI_ReloadSpeed = 0.45;

force LRG_AI_SpotDistance = 0.3;

force LRG_AI_SpotTime = 0.15;
