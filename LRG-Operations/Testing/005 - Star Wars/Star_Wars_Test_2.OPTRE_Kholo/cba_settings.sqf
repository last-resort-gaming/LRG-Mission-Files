...
force DBA_Hyperspace_Offset_C9979 = 180;


force DBA_Hyperspace_Offset_CR90 = 180;

force DBA_Hyperspace_Offset_Default = 0;

force DBA_Hyperspace_Offset_Hammerhead = 180;

force DBA_Hyperspace_Offset_Munificent = 90;

force DBA_Hyperspace_Offset_Nebulon = 180;
...
force TAS_jetcoolset = 0.5;

force TAS_jetfuelset = 0.5;

force TAS_jetheatset = 0.5;

force TAS_jetsoundvol = 0.5;
...
force fscl_stateThreshold = 30.1295;
...
force JLTS_settings_jumppack_customConsumption = true;

force JLTS_settings_jumppack_customConsumptionCoef = 0.509115;

force JLTS_settings_jumppack_mainSwitch = 1;

force JLTS_settings_jumppack_profileDescentCoef = 0.3;

force JLTS_settings_jumppack_profileDescentRatio = "1,1";

force JLTS_settings_jumppack_profileHighCoef = 1;

force JLTS_settings_jumppack_profileHighRatio = "1,2";

force JLTS_settings_jumppack_profileLongCoef = 1;

force JLTS_settings_jumppack_profileLongRatio = "2,1";

force JLTS_settings_jumppack_profileStandardCoef = 1;

force JLTS_settings_jumppack_profileStandardRatio = "1,1";
