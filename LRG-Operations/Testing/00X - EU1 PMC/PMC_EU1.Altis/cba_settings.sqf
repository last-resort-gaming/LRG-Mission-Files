...
force ace_medical_treatment_cprSuccessChanceMax = 0.24;

force ace_medical_treatment_cprSuccessChanceMin = 0.24;
...
force force adv_aceCPR_chance_0 = 8;

force force adv_aceCPR_chance_1 = 18;
