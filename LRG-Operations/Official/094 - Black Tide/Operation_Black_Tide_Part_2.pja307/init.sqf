...
//null = [340,400,true,true,false,0.1] execvm "AL_dust_storm\al_duststorm.sqf";



while {true} do {
null = [10,400+(random 100),true,true,false,0.1] execvm "AL_dust_storm\al_duststorm.sqf";
