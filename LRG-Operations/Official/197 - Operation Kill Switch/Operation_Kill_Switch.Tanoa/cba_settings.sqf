...
force force ace_common_restedSwayFactor = 0.1;
...
force force ace_medical_treatment_cprSuccessChanceMax = 0.7;
force force ace_medical_treatment_cprSuccessChanceMin = 0.7;
...
force force ace_nametags_playerNamesViewDistance = 20;
