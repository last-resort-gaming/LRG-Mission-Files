					...
					
        {
            if((driver _vehicle == _x) || (gunner _vehicle == _x)) then
            {
                ...
                if(driver _vehicle == _x) then
                {
                    ...
                    _name = format ["<t size='0.90' color='#FFAE00'>%1 %2</t> <img size='0.85' color='#FFAE00' image='a3\ui_f\data\IGUI\Cfg\Actions\getindriver_ca.paa'/><br/>", _name, (name _x)];
                }
			  ...
			  _Azimuth = round  (((_wepdir select 0) ) atan2 ((_wepdir select 1) ) + 360) % 360;
                    _name = format ["<t size='0.85' color='#FFAE00'>%1 %2</t> <img size='0.7' color='#FFAE00' image='a3\ui_f\data\IGUI\Cfg\Actions\getingunner_ca.paa'/><br/> <t size='0.85' color='#FFAE00'>Heading :<t/> <t size='0.85' color='#FFAE00'>%3</t><br/><t size='0.85' color='#FFAE00'> Target :<t/> <t size='0.85' color='#FFAE00'>%4</t><br/><t size='0.85' color='#FFAE00'> Display : </t><t size='0.85' color='#FFAE00'><img size='1' image='%5'/></t><br/>", _name, (name _x), _Azimuth,_vehicleID, _picture];
            ...
            {
                _name = format ["<t size='0.85' color='#FFAE00'>%1 %2</t> <img size='0.7' color='#FFAE00' image='a3\ui_f\data\IGUI\Cfg\Actions\getincargo_ca.paa'/><br/>", _name, (name _x)];
            };  
