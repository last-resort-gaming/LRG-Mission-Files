...
force ace_common_deployedSwayFactor = 0.25;
...
force ace_common_restedSwayFactor = 0.5;
...
grenades_hatches_main_disablePlayerAmbush = false;
...
force ace_overheating_coolingCoef = 1.75;
...
force ace_repair_repairDamageThreshold_engineer = 0.40031;
...
RECOIL_accumulative_on = 1.02;
RECOIL_AI_aimingAccuracyMax_on = 1;
RECOIL_AI_aimingAccuracyMin_on = 1;
RECOIL_AI_aimingShakeMax_on = 1;
RECOIL_AI_aimingShakeMin_on = 1;
RECOIL_AI_aimingSpeedMax_on = 1;
RECOIL_AI_aimingSpeedMin_on = 1;
RECOIL_AI_commandingMax_on = 1;
RECOIL_AI_commandingMin_on = 1;
RECOIL_AI_courageMax_on = 1;
RECOIL_AI_courageMin_on = 1;
RECOIL_AI_deviation = 0;
RECOIL_AI_deviationDistance = 0;
RECOIL_AI_deviationVisibility = 0;
RECOIL_AI_enduranceMax_on = 1;
RECOIL_AI_enduranceMin_on = 1;
RECOIL_AI_generalMax_on = 1;
RECOIL_AI_generalMin_on = 1;
force RECOIL_AI_on = false;
RECOIL_AI_reloadSpeedMax_on = 1;
RECOIL_AI_reloadSpeedMin_on = 1;
force RECOIL_AI_skill_on = false;
force RECOIL_AI_skilladd_on = false;
RECOIL_AI_spotDistanceMax_on = 1;
RECOIL_AI_spotDistanceMin_on = 1;
RECOIL_AI_spotTimeMax_on = 1;
RECOIL_AI_spotTimeMin_on = 1;
force RECOIL_force_on = 150;
RECOIL_handgun_on = true;
force RECOIL_incrase_on = 0.4;
RECOIL_limit_on = 1.8;
RECOIL_negative_on = 2;
RECOIL_new_on = true;
RECOIL_random_on = true;
force RECOIL_randomMax_on = 1;
force RECOIL_randomMid_on = 0.7;
force RECOIL_randomMin_on = -1.4;
RECOIL_Smooth_on = true;
force RECOIL_variety_on = false;
RECOIL_varietyC_on = 1;
RECOIL_varietyCk_on = 2;
force SWAY_incrase_on = 0.755;

// Autokit PLUS
AutoKit_PLUS_ACE_Initbox = false;
AutoKit_PLUS_AddGearOnTraitCHECK = true;
AutoKit_PLUS_AM_ACE3_BasicItems = "[""ItemGPS"",""ACE_MapTools"",""ACE_Flashlight_XL50"",""ACE_EntrenchingTool""]";
AutoKit_PLUS_AM_ACE3_BasicUnit_Divider = 2;
AutoKit_PLUS_AM_ACE3_Injectors = 5;
AutoKit_PLUS_AM_ACE3_IV_Blood = 5;
AutoKit_PLUS_AM_ACE3_IV_Plasma = 5;
AutoKit_PLUS_AM_ACE3_IV_Saline = 5;
AutoKit_PLUS_AM_ACE3_Medical_Bandages = 20;
AutoKit_PLUS_AM_ACE3_Splints = 4;
AutoKit_PLUS_AM_ACE3_Tourniquets = 4;
AutoKit_PLUS_AM_baseGame_IFAK = 4;
AutoKit_PLUS_AM_baseGame_MEDKIT = 1;
AutoKit_PLUS_AM_MachinegunBelts = 4;
AutoKit_PLUS_AM_PrimaryMags = 8;
AutoKit_PLUS_AM_Rockets = 2;
AutoKit_PLUS_AM_SecondaryMags = 4;
AutoKit_PLUS_AM_UnderslungGrenades = 7;
AutoKit_PLUS_ApplytoGroupCHECK = true;
AutoKit_PLUS_AssignTraitCHECK = true;
AutoKit_PLUS_BasicItemsCHECKER = true;
AutoKit_PLUS_BI_Initbox = true;
AutoKit_PLUS_CopytoClipboard = true;
AutoKit_PLUS_EOD_BASIC_DetectorCHECKER = false;
AutoKit_PLUS_EODDetectorCHECKER = true;
AutoKit_PLUS_PlayerArsenal_BoxType = """VirtualReammoBox_small_F""";
AutoKit_PLUS_SelectBLUFOR = true;
AutoKit_PLUS_SelectCIV = false;
AutoKit_PLUS_SelectIND = false;
AutoKit_PLUS_SelectOPFOR = false;
...
CBRN_DeathAnims = true;
CBRN_debugEnabled = false;
CBRN_Dev_Mutants_toggle = true;
CBRN_DisableFaceSetting_toggle = false;
CBRN_DisableForAI_toggle = false;
CBRN_DisableForCivilian_toggle = false;
CBRN_DisableForEast_toggle = false;
CBRN_DisableForIndependent_toggle = false;
CBRN_DisableForPlayers_toggle = false;
CBRN_DisableForWest_toggle = false;
CBRN_DisableTheWholeThing_toggle = false;
...
CBRN_exposureDeathThreshold = 10;
CBRN_exposureKnockoutThreshold = 7;
CBRN_exposureLimpThreshold = 5;
force CBRN_factionMask_BLU_CTRG_F = "G_AirPurifyingRespirator_02_olive_F";
force CBRN_factionMask_BLU_F = "G_AirPurifyingRespirator_01_F";
force CBRN_factionMask_BLU_G_F = "G_RegulatorMask_F";
force CBRN_factionMask_BLU_GEN_F = "G_Respirator_white_F";
force CBRN_factionMask_BLU_T_F = "G_AirPurifyingRespirator_01_F";
force CBRN_factionMask_BLU_W_F = "G_AirPurifyingRespirator_01_F";
force CBRN_factionMask_CBRN_Civ = "G_RegulatorMask_F";
force CBRN_factionMask_CIV_F = "G_Respirator_white_F";
force CBRN_factionMask_CIV_IDAP_F = "G_RegulatorMask_F";
CBRN_factionMask_EODS_APOBS = "";
CBRN_factionMask_EODS_BOT = "";
force CBRN_factionMask_Expansion_Mod_Gendarmerie_CBRN_Div = "G_RegulatorMask_F";
force CBRN_factionMask_FFAA = "G_CBRN_M04_Hood";
CBRN_factionMask_FIR_AWS_ENEMY_F = "";
CBRN_factionMask_FIR_AWS_FRND_F = "";
CBRN_factionMask_GX_B_C_Faction = "";
force CBRN_factionMask_IND_C_F = "G_Respirator_white_F";
force CBRN_factionMask_IND_E_F = "G_Respirator_white_F";
force CBRN_factionMask_IND_F = "G_RegulatorMask_F";
force CBRN_factionMask_IND_G_F = "G_RegulatorMask_F";
force CBRN_factionMask_IND_L_F = "G_Bandanna_khk";
CBRN_factionMask_Interactive_F = "";
force CBRN_factionMask_OPF_F = "G_AirPurifyingRespirator_02_olive_F";
force CBRN_factionMask_OPF_G_F = "G_AirPurifyingRespirator_02_olive_F";
force CBRN_factionMask_OPF_GEN_F = "G_RegulatorMask_F";
force CBRN_factionMask_OPF_R_F = "G_AirPurifyingRespirator_02_olive_F";
force CBRN_factionMask_OPF_T_F = "G_AirPurifyingRespirator_02_sand_F";
force CBRN_factionMask_OPF_V_F = "G_Respirator_white_F";
CBRN_factionMask_rhs_faction_usmc_d = "";
CBRN_factionMask_rhs_faction_usmc_wd = "";
CBRN_factionMask_UK3CB_BAF_Faction = "";
CBRN_factionMask_UK3CB_BAF_Faction_Airforce = "";
CBRN_factionMask_UK3CB_BAF_Faction_Army_MTP = "";
CBRN_factionMask_UK3CB_BAF_Faction_Navy_MTP = "";
CBRN_factionMask_Virtual_F = "";
force CBRN_factionMask_VSM_GP = "G_RegulatorMask_F";
CBRN_factionMask_WBK_AI = "";
CBRN_factionMask_WBK_AI_Melee = "";
CBRN_factionMask_WBK_AI_ZHAMBIES = "";
force CBRN_Flood_toggle = false;
CBRN_GasMask_Style_setting = 1;
CBRN_GasMasks_DammageAllowed_toggle = true;
CBRN_Maskoverlay = true;
CBRN_medical_gasmask_durability = 240;
force CBRN_OnlyDepleteInsideGas = true;
force CBRN_RenegadeConversion_setting = true;
CBRN_ScreenEffects_MasterToggle = true;
force CBRN_SealTimer = 30;
CBRN_WBK_Combine_toggle = false;
...
CBRN_WBK_ZoC_toggle = true;
CBRN_ZombieImmunity_toggle = true;
...
force diwako_dui_nametags_fontNameSize = 8;
...
cigs_core_set_adv_fatigue_cough_modifier = 1;
cigs_core_set_adv_fatigue_decrease_delay = 5;
cigs_core_set_adv_fatigue_enabled = true;
cigs_core_set_adv_fatigue_modifier = 1;
cigs_core_set_effect_combustion_chance = 0.1;
...
force cigs_core_set_cigsonai_chance = 0.75;
...
// LAMBS Danger
force lambs_danger_cqbRange = 40.5;
...
// RID
force rid_core_requireEngineer = false;
rid_core_requireSpecialist = true;

// SHGT Survivable Wrecks
force SHGT_SW_damageMultiplier = 2;
SHGT_SW_damageTreshold = 0.88;
force SHGT_SW_eject_crew = true;
SHGT_SW_ignore_AI_Units = false;
SHGT_SW_ignore_AI_vehicles = false;
SHGT_SW_ignore_grounded_vehicles = false;
SHGT_SW_immune_damage = true;
SHGT_SW_unconscious = false;
SHGT_SW_vehicle_destruction_enabled = true;
SHGT_SW_VehTypes_ClassIgnore_setting = "[""classname1"",""classname2""]";
SHGT_SW_VehTypes_Drone = false;
SHGT_SW_VehTypes_Ground = false;
SHGT_SW_VehTypes_Heli = true;
SHGT_SW_VehTypes_Plane = true;
...
force sss_optionnotificationStyle = 1;
...
stx_civilians_driverSpawnDelay = 0.3;
...
stx_civilians_parkedSpawnDelay = 0.35;
stx_civilians_parkedSpawnRadius = 500;
stx_civilians_pedestrianCount = 6;
stx_civilians_pedSpawnDelay = 0.2;
...
force stx_common_arsenalAnimEnabled = true;
stx_common_arsenalBlacklistStr = "";
stx_common_arsenalDummyEnabled = false;
stx_common_arsenalWhitelistStr = "";
stx_common_hintType = 2;
stx_common_skillAimingAccuracy = 0.5;
stx_common_skillAimingShake = 0.5;
stx_common_skillAimingSpeed = 0.5;
stx_common_skillCommanding = 0.5;
stx_common_skillCourage = 0.5;
stx_common_skillGeneral = 0.5;
stx_common_skillReloadSpeed = 0.5;
stx_common_skillSpotDistance = 0.5;
stx_common_skillSpotTime = 0.5;
...
stx_extras_virtualDriverClone = false;
...
tsp_cba_breach_lock_door = 0.2;
tsp_cba_breach_lock_house = 0.2;
...
zen_faction_filter_0_OPF_GEN_F = false;
