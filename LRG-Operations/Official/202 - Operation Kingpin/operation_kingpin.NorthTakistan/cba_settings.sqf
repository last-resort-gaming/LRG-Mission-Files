...
force A3U_setting_tierWarElite = 8;
force A3U_setting_tierWarHRLoss = 2;
force A3U_setting_tierWarMilitia = 3;
force A3U_setting_tierWarPunishments = 3;
force force menu_framework_image = "\x\A3A\addons\main_menu\data\backgrounds\images\selfie_co.jpg";
...
// Dynamic Music
hl2dynamic_debug = false;
hl2dynamic_setting = true;

// Dynamic Wasteland
hl2dynamic_CombatDuration = 5;
hl2dynamic_SafeDuration = 15;
...
// Enhanced Trenches
force EHT_bunkerDigDuration = 20;
force EHT_bunkerRemoveDuration = 20;
force EHT_Endtrench_HalfDigDuration = 20;
force EHT_Endtrench_HalfRemoveDuration = 20;
force EHT_EndtrenchDigDuration = 20;
force EHT_EndtrenchRemoveDuration = 20;
force EHT_FoxholeDigDuration = 20;
force EHT_FoxholeRemoveDuration = 20;
force EHT_NestDigDuration = 20;
force EHT_NestRemoveDuration = 20;
force EHT_Straightrench_HalfDigDuration = 20;
force EHT_Straightrench_HalfRemoveDuration = 20;
force EHT_StraightrenchDigDuration = 20;
...
force EHT_TrenchMiddleDigDuration = 20;
...
// Our Benefactors
force WBK_OB_ArsenalSetting = true;
force WBK_OB_EnablePlayerFlinches = false;
force WBK_OB_ShowSubtSetting = true;

// Sci-fi Support PLUS
force ScifiSupportPlus_AmbientShipSound_Radius = "5000";
force ScifiSupportPlus_AutoDeleteTimer = "180";
force ScifiSupportPlus_CombineMortars = true;
force ScifiSupportPlus_COMBINETeleporter = true;
force ScifiSupportPlus_COMBINETeleporter_customUnit = "[""O_Soldier_F"",""B_Soldier_F""]";
force ScifiSupportPlus_CrashShip = false;
force ScifiSupportPlus_DisengageEngageToggle = false;
force ScifiSupportPlus_EXTERMINATUSHot = false;
force ScifiSupportPlus_EXTERMINATUSVirus = false;
force ScifiSupportPlus_HeadCrabPod = true;
force ScifiSupportPlus_HL_AntlionNest = true;
force ScifiSupportPlus_JumpShipIn = false;
force ScifiSupportPlus_JumpShipOut = false;
force ScifiSupportPlus_MoveShip = false;
force ScifiSupportPlus_MoveShip_Speed = "0.001";
force ScifiSupportPlus_PatrolShip = false;
...
force ScifiSupportPlus_SupportShip_FireAtTarget = false;
force ScifiSupportPlus_SupportShip_HP_value = "1000";
force ScifiSupportPlus_SupportShip_PatrolCooldownTimer_value = "180";
force ScifiSupportPlus_WH40K_DaemonTeleporter = false;
force ScifiSupportPlus_WH40K_DaemonTeleporter_customUnit = "[""O_Soldier_F"",""B_Soldier_F""]";
force ScifiSupportPlus_XENTeleporter = true;
force ScifiSupportPlus_XENTeleporter_customUnit = "[""O_Soldier_F"",""B_Soldier_F""]";
