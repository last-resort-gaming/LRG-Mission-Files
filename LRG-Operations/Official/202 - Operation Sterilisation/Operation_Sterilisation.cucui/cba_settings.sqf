...
PHEN_arsenal_animations = true;
VKN_arsenal_animations = true;
...
// CQB Interactions
CQB_CarryCaptive_Interaction_Disable_Toggle = false;
CQB_Detain_Interaction_Disable_Toggle = false;
CQB_DetainDeadBody_Interaction_Disable_Toggle = false;
CQB_FollowOrder_Interaction_Disable_Toggle = false;
CQB_Interactions_DisableForCivilian_toggle = false;
CQB_Interactions_DisableForEast_toggle = false;
CQB_Interactions_DisableForIndependent_toggle = false;
CQB_Interactions_DisableForWest_toggle = false;
CQB_Interactions_DisableTheWholeThing_toggle = false;
CQB_Interactions_MoraleModifier = 1;
CQB_Interactions_PlayerVoice_toggle = true;
CQB_Interactions_ShockStunThreshold = 0.5;
CQB_Interactions_ShoutingDistance = 50;
CQB_Interactions_SurrenderThreshold = 0.25;
CQB_Interactions_UnarmedCiviliansExtradamage_Toggle = true;
CQB_MoveCaptive_Interaction_Disable_Toggle = false;
CQB_MoveIntoVehicles_Interaction_Disable_Toggle = false;
CQB_RemoveWeapons_Toggle = false;
...
zen_faction_filter_0_BRAF_CRATENIA = true;
zen_faction_filter_0_BRAF_FACTIONS = true;
zen_faction_filter_0_BRAF_Thugs = true;
...
zen_faction_filter_1_BRAF_FACTIONS = true;
zen_faction_filter_1_BRAF_HIAF = true;
zen_faction_filter_1_VSM_GP = true;
zen_faction_filter_2_BRAF_ARMY = true;
zen_faction_filter_2_BRAF_FAB = true;
zen_faction_filter_2_BRAF_FACTIONS = true;
zen_faction_filter_2_BRAF_NAVY = true;
zen_faction_filter_2_I_BrasilAirForce_Lizard = true;
zen_faction_filter_2_I_BrasilNavy_Lizard = true;
zen_faction_filter_2_I_BrazilArmy_LizardCamo = true;
zen_faction_filter_2_I_UnitedNationsPeaceKeepingForce = true;
...
zen_faction_filter_2_SUD_RU = true;
