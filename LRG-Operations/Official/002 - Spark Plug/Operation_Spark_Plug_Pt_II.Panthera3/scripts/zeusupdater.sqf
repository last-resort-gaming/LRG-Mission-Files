...
waitUntil {time > 3};
call {while {true} do {objectsToAdd = (entities "AllVehicles"); publicVariable "objectsToAdd";{_x addCuratorEditableObjects [(objectsToAdd), true]; } foreach allCurators; sleep 180;};};
