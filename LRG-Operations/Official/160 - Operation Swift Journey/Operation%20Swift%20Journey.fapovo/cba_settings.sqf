...
CBRN_factionMask_cwr3_faction_civ = "";
CBRN_factionMask_cwr3_faction_fia = "";
CBRN_factionMask_cwr3_faction_rebels_east = "";
CBRN_factionMask_cwr3_faction_rebels_west = "";
CBRN_factionMask_cwr3_faction_rus = "";
CBRN_factionMask_cwr3_faction_rus_des = "";
CBRN_factionMask_cwr3_faction_uk = "";
CBRN_factionMask_cwr3_faction_usa = "";
CBRN_factionMask_cwr3_faction_usa_des = "";
CBRN_factionMask_cwr3_faction_usmc = "";
CBRN_factionMask_cwr3_faction_vdv = "";
CBRN_factionMask_cwr3_faction_vmf = "";
CBRN_factionMask_DSF_ABUS = "";
CBRN_factionMask_DSF_AFMIL = "";
CBRN_factionMask_DSF_ANA = "";
CBRN_factionMask_DSF_BOKO = "";
CBRN_factionMask_DSF_CART = "";
CBRN_factionMask_DSF_CAUC = "";
CBRN_factionMask_DSF_CHECH = "";
CBRN_factionMask_DSF_CIA = "";
CBRN_factionMask_DSF_Civilians = "";
CBRN_factionMask_DSF_COP = "";
CBRN_factionMask_DSF_CORP = "";
CBRN_factionMask_DSF_HAMAS = "";
CBRN_factionMask_DSF_HTS = "";
CBRN_factionMask_DSF_IDF = "";
CBRN_factionMask_DSF_IGF = "";
CBRN_factionMask_DSF_IRAN = "";
CBRN_factionMask_DSF_ISIS = "";
CBRN_factionMask_DSF_LDPR = "";
CBRN_factionMask_DSF_MIL = "";
CBRN_factionMask_DSF_PMF = "";
CBRN_factionMask_DSF_SAA = "";
CBRN_factionMask_DSF_TAL = "";
CBRN_factionMask_DSF_UAF = "";
CBRN_factionMask_DSF_UKR = "";
CBRN_factionMask_DSF_USMILITIA = "";
CBRN_factionMask_DSF_WAG = "";
...
CBRN_factionMask_rds_pol_civ = "";
CBRN_factionMask_rds_rus_civ = "";
CBRN_factionMask_rds_sff_blufor = "";
CBRN_factionMask_rds_sff_indep = "";
CBRN_factionMask_rds_sff_opfor = "";
...
force WBK_DeathAnimMod_Hit_Chance = "75";
...
tsp_cba_breach_ace_locking = true;
tsp_cba_breach_ammo = "[""B_12Gauge_Slug_NoCartridge"", ""rhs_ammo_12g_slug"", ""rhs_ammo_12g_00buckshot""]";
tsp_cba_breach_ammoMultiplier = 1;
tsp_cba_breach_autoTime = 5;
tsp_cba_breach_lockBlacklist = "[]";
tsp_cba_breach_lockDoor = 0.75;
tsp_cba_breach_lockHouse = 0.25;
...
tsp_cba_breach_wall_velocity = "[0,0,-0.5]";

// TSP Melee
tsp_cba_melee = true;
tsp_cba_melee_damageModifier = 1;
tsp_cba_melee_moveset = true;
tsp_cba_melee_movesetPoll = 0.25;
