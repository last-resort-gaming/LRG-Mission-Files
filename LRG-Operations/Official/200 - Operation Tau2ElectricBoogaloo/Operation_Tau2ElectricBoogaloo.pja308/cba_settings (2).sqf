...
force ace_overheating_suppressorCoef = 1.25;
...
force force adv_aceCPR_chance_0 = 40;
force force adv_aceCPR_chance_1 = 50;
force force adv_aceCPR_chance_2 = 70;
...
force RECOIL_accumulative_on = 1.02;
...
force RECOIL_force_on = 50;
force RECOIL_handgun_on = true;
force RECOIL_incrase_on = 1.2;
force RECOIL_limit_on = 1.8;
...
force cigs_core_set_cigsonai_chance = 0.330363;
...
force cigs_core_set_cigsonai_custom_#_CIV_cigs_pops_poppack = false;
...
// T-72 Turret Ejector Seat Settings
cox_t72turret_custom = "Tank_1,Tank_2";
cox_t72turret_enable = true;
cox_t72turret_slammer_enable = true;
cox_t72turret_texselection_setting = 1;

// TBD Mortars Main
TBD_MORTARS_main_assemble105Time = 5;
TBD_MORTARS_main_chargeChangeTime = 5;
TBD_MORTARS_main_disassemble105Time = 5;
TBD_MORTARS_main_loadTime = 1;
TBD_MORTARS_main_pack105Time = 5;
TBD_MORTARS_main_unloadTime = 5;
TBD_MORTARS_main_unpack105Time = 5;
...
force force zeus_additions_main_enableMissionCounter = true;
...
zen_faction_filter_0_cwr3_faction_rebels_east = true;
zen_faction_filter_0_cwr3_faction_rus = true;
...
zen_faction_filter_1_cwr3_faction_rebels_west = true;
zen_faction_filter_1_cwr3_faction_uk = true;
zen_faction_filter_1_cwr3_faction_usa = true;
zen_faction_filter_1_cwr3_faction_usa_des = true;
zen_faction_filter_1_CWR3_USA = true;
zen_faction_filter_1_CWR3_USA_DES = true;
...
zen_faction_filter_2_cwr3_faction_fia = true;
...
zen_faction_filter_3_cwr3_faction_civ = true;
