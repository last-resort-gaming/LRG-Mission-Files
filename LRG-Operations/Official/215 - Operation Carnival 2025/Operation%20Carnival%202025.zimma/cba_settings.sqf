...
AAA_VAR_ARMOR_THRESHOLD_VALUE = 0;
AAA_VAR_BASE_ARMOR_VALUE = 0;
force AAA_VAR_BLUFOR_ARMOR_COEF = 8;
AAA_VAR_CIV_ARMOR_COEF = 0;
AAA_VAR_DEBUG = false;
force AAA_VAR_EXPLOSIVE_MULT = 20;
AAA_VAR_FORCE_BASE_ARMOR = false;
AAA_VAR_HITABDOMEN_ENABLED = true;
AAA_VAR_HITABDOMEN_MULT = 0;
AAA_VAR_HITARMS_ENABLED = true;
AAA_VAR_HITARMS_MULT = 0;
AAA_VAR_HITBODY_ENABLED = true;
AAA_VAR_HITBODY_MULT = 0;
AAA_VAR_HITCHEST_ENABLED = true;
AAA_VAR_HITCHEST_MULT = 0;
AAA_VAR_HITDIAPHRAGM_ENABLED = true;
AAA_VAR_HITDIAPHRAGM_MULT = 0;
AAA_VAR_HITFACE_ENABLED = true;
AAA_VAR_HITFACE_MULT = 0;
AAA_VAR_HITHANDS_ENABLED = true;
AAA_VAR_HITHANDS_MULT = 0;
AAA_VAR_HITHEAD_ENABLED = true;
AAA_VAR_HITHEAD_MULT = 0;
AAA_VAR_HITLEGS_ENABLED = true;
AAA_VAR_HITLEGS_MULT = 0;
AAA_VAR_HITNECK_ENABLED = true;
AAA_VAR_HITNECK_MULT = 0;
AAA_VAR_HITPELVIS_ENABLED = true;
AAA_VAR_HITPELVIS_MULT = 0;
AAA_VAR_IND_ARMOR_COEF = 0;
AAA_VAR_MOD_ENABLED = true;
force AAA_VAR_OPFOR_ARMOR_COEF = 10;
AAA_VAR_PLAYER_ARMOR_COEF = 15;
AAA_VAR_PLAYERS_ENABLED = true;
...
// Android Ascension - Vanguard
SSV_Vanguard_Setting_Enable_OrganicGrenade = true;
...
RECOIL_AI_skill_on = true;
RECOIL_AI_skilladd_on = true;
...
BCE_AI_CAS_Support_fn = false;
BCE_AIAir_IR_fn = true;
BCE_cTab_Marker_Sync = "_USER";
BCE_cTab_Marker_Sync_time = 1;
BCE_cTab_Side_Display = true;
BCE_inf_IR_Lig_S_fn = true;
BCE_LandVeh_Laser_fn = false;
BCE_LandVeh_Light_fn = false;
BCE_veh_IR_S_fn = true;
...
force emr_main_preventHighVaulting = true;
...
force hatg_setting_distance_reset = 8.1;
force hatg_setting_distance_shots = 7.05;
...
// Immersive Cigs - AI
cigs_ai_set_cigsonai_chance = 0.33;
...
cigs_ai_set_cigsonai_delay = 5;
cigs_ai_set_cigsonai_enable = true;
cigs_ai_set_cigsonai_side_enabled_CIV = true;
cigs_ai_set_cigsonai_side_enabled_EAST = true;
cigs_ai_set_cigsonai_side_enabled_GUER = true;
cigs_ai_set_cigsonai_side_enabled_WEST = true;
cigs_ai_set_dynamicSmoking_checkUnitInventory = true;
cigs_ai_set_dynamicSmoking_enable = true;
cigs_ai_set_dynamicSmoking_slot = "GOGGLES";
cigs_ai_set_dynamicSmoking_slot_remove = true;
cigs_ai_set_dynamicSmoking_time_avg = 15;
...
cigs_core_set_require_holstered_weapon = true;
...
PHEN_DoorKick_RandomDoorChance_Kick = 0.55;
...
// Pinned Down
Mikeys_AISkill_cap = 0.35;
force Mikeys_AISup_burstSec = 2;
Mikeys_AISup_capSec = 12;
force Mikeys_AISup_distance = 30;
Mikeys_AISup_halflife = 5;
Mikeys_AISup_strength = 1;
Mikeys_AISupEnable = true;
Mikeys_AIUseSuppressiveFire = true;
Mikeys_PLAYER_SUP_ENABLED = true;
MKY_BRAIN_HYBRID = true;
force PD_AIM_DMG_MULT = 2.1;
PD_AIM_EASE = 0.07;
PD_AIM_MAX = 12;
force PD_AIM_SUP_MULT = 1.45;
PD_BLINK_COOLDOWN = 2.2;
PD_BLINK_ENABLE = true;
force PD_CAMSHAKE_ENABLE = false;
PD_CAMSHAKE_MULT = 1.25;
PD_DECAY_HALFLIFE = 1.1;
PD_EVENT_LATCH = 0.25;
PD_MIN_IMPULSE_UP = 0.02;
PD_RECOIL_STRESS_MULT = 0.91;
PD_RED_CAP = 0.25;
PD_SUP_FLOOR = 0.08;
PD_TICK = 0.5;
force PD_TUNNEL_CAP = 0.6;
PD_TUNNEL_CD = 0.35;
PD_TUNNEL_FADE = 1.15;
force PD_TUNNEL_ONSET = 0.098;
PD_VISUAL_MODE = 2;

// Sci-fi Support PLUS
ScifiSupportPlus_AmbientShipSound_Radius = "7000";
...
// Scifi Spaceship Pack
TKE_Ext_Ships_PylonControlFixEnabled = true;
...
WBK_MeltaKillWeapons = "['TIOW_MeltaGun_01','TIOW_Bike_Multi_Melt','TIOW_SM_MeltaGun_01','WBK_SolarAux_MeltaGun','WBK_SolarAux_MeltaGun_Dark']";
WBK_PlasmaKillColor = "Green";
WBK_PlasmaKillWeapons = "['TKE_UCNLasRifle','TIOW_StaffOfLight_Base','TIOW_StaffOfLight_Mephrit','TIOW_StaffOfLight_Thokt','TIOW_GaussFlayer_Base','TIOW_GaussFlayer_Mephrit','TIOW_GaussFlayer_Thokt','DK_PlasmaGun','Chaos_PlasmaGun','TIOW_IG_Plasmagun_01','TIOW_SM_Ragefire_PlasmaGun']";
...
WBK_DualWeapons_SaveWeaponAfterRespawn = false;
...
zen_faction_filter_0_9E_Faction = true;
zen_faction_filter_0_HC_Faction = true;
zen_faction_filter_0_JMSJEFF_Yasher_fact = true;
zen_faction_filter_0_MAWS_Faction = true;
zen_faction_filter_0_NHI_Faction = true;
zen_faction_filter_0_O_KEF_FCF = true;
zen_faction_filter_0_O_KEF_KMCWU = true;
zen_faction_filter_0_O_KEF_MDMC = true;
zen_faction_filter_0_O_KEF_MDMC_W = true;
zen_faction_filter_0_O_KEF_MDTF = true;
zen_faction_filter_0_O_KEF_MDTF_C = true;
zen_faction_filter_0_O_KEF_MDTF_W = true;
zen_faction_filter_0_O_KEF_Mercs = true;
zen_faction_filter_0_O_KEF_MPDF = true;
...
zen_faction_filter_0_TKE_Ext_MD = true;
zen_faction_filter_0_TKE_Ext_S_Spaceforce_Redfor = true;
zen_faction_filter_0_TRF_Faction = true;
zen_faction_filter_0_WBK_AI = true;
zen_faction_filter_0_WBK_AI_Melee = true;
zen_faction_filter_0_WBK_WGP_OPFOR = true;
zen_faction_filter_0_WV_Faction = true;
zen_faction_filter_0_WV_Faction_Groups_O = true;
zen_faction_filter_1_B_KEF_FEDRA = true;
zen_faction_filter_1_B_KEF_KMCWU = true;
zen_faction_filter_1_B_KEF_Mercs = true;
zen_faction_filter_1_B_KEF_UCEF = true;
zen_faction_filter_1_B_KEF_UCEFR = true;
zen_faction_filter_1_B_KEF_UCEFR_W = true;
zen_faction_filter_1_B_KEF_UCFAFR = true;
zen_faction_filter_1_B_KEF_UCMC = true;
zen_faction_filter_1_B_KEF_UCMC_C = true;
zen_faction_filter_1_B_KEF_UCMC_W = true;
zen_faction_filter_1_B_KEF_UCP = true;
...
zen_faction_filter_1_ITA_Faction = true;
...
zen_faction_filter_1_TKE_Ext_UCN = true;
zen_faction_filter_1_TKE_UCN_Drop_Pods = true;
zen_faction_filter_1_UCMC_Faction = true;
zen_faction_filter_1_WBK_AI = true;
zen_faction_filter_1_WBK_AI_Melee = true;
zen_faction_filter_1_WBK_WGP_BLUFOR = true;
zen_faction_filter_2_9E_Faction_I = true;
zen_faction_filter_2_HC_Faction_I = true;
zen_faction_filter_2_I_DES_MD = true;
zen_faction_filter_2_I_DES_UCN = true;
zen_faction_filter_2_I_ICSMarines = true;
zen_faction_filter_2_I_KEF_FCF = true;
zen_faction_filter_2_I_KEF_KMC = true;
zen_faction_filter_2_I_KEF_Mercs = true;
...
zen_faction_filter_2_ITA_Faction_I = true;
zen_faction_filter_2_MB_Faction = true;
zen_faction_filter_2_NHI_Faction_I = true;
zen_faction_filter_2_SSV_Aux_Vanguard = true;
zen_faction_filter_2_WBK_WGP_INDFOR = true;
zen_faction_filter_3_CIV_F = true;
zen_faction_filter_3_CIV_IDAP_F = true;
zen_faction_filter_3_CIV_KEF = true;
