...
force AAA_VAR_BLUFOR_ARMOR_COEF = 10;
AAA_VAR_CIV_ARMOR_COEF = 0;
AAA_VAR_DEBUG = false;
force AAA_VAR_EXPLOSIVE_MULT = 7.5;
...
force AAA_VAR_OPFOR_ARMOR_COEF = 5;
...
boxloader_hidecargo_enabled = false;
...
boxloader_retrofit_enabled = false;
...
force dzn_EJAM_AllowFullInspectMenu = true;
dzn_EJAM_dud_ChanceSettings = 60;
...
cigs_core_set_sp_addCigpack_type = "cigs_nil_cigpack";
cigs_core_set_sp_addItems = false;
cigs_core_set_sp_addLighter = true;
cigs_core_set_sp_addLighter_type = "cigs_matches";

// K9 Companion
K9Companion_HealTime = 30;
K9Companion_MaxDistance = 1000;
K9Companion_ReturnHomeTime = 15;
K9Companion_TimeBeforeForcedReturn = 120;
...
force stx_logistics_medicalDefaultsStr = "[""ACE_fieldDressing"",""ACE_packingBandage"",""ACE_elasticBandage"",""ACE_tourniquet"",""ACE_splint"",""ACE_morphine"",""ACE_adenosine"",""ACE_epinephrine"",""ACE_bloodIV"",""ACE_bloodIV_500"",""ACE_bloodIV_250""]";
...
zen_faction_filter_0_EdCat_Dogs = true;
zen_faction_filter_0_IND_F = true;
zen_faction_filter_0_JK_O_RUS_F = true;
zen_faction_filter_0_JK_O_TKA_F = true;
...
zen_faction_filter_0_rds_sff_opfor = true;
zen_faction_filter_0_rhs_faction_msv = true;
zen_faction_filter_0_rhs_faction_NK = true;
...
zen_faction_filter_0_rhs_faction_WPRG = true;
...
zen_faction_filter_2_rds_sff_indep = true;
...
zen_faction_filter_3_EdCat_Dogs = true;
