...
BTC_player_respawn = {
	...
	if (BTC_active_lifes != 1 || BTC_lifes != 0) then
	{
		...
		_pilots = ["B_Pilot_F","B_Helipilot_F","B_helicrew_F","O_Pilot_F","O_Helipilot_F","O_helicrew_F","I_Pilot_F","I_Helipilot_F","I_helicrew_F","B_soldier_UAV_F","UK3CB_BAF_HeliPilot_RAF"];
