...
force ace_frag_maxTrack = 7.5;

force ace_frag_maxTrackPerFrame = 7.5;
...
force ace_finger_indicatorForSelf = false;
...
force acex_field_rations_timeWithoutWater = 0.5;
...
force LRG_Channels_SideText = false;
...
force LRG_QS_ST_enableGroupIcons = false;

force LRG_QS_ST_gps_enableUnitIcons = false;
...
force LRG_QS_ST_map_enableUnitIcons = false;
...
force LRG_QS_ST_showFactionOnly = flase;
