...
BTC_who_can_revive  = ["B_medic_F","B_recon_medic_F","B_G_medic_F","O_medic_F","I_medic_F","O_recon_medic_f","CUP_B_BAF_Medic_MTP","UK3CB_BAF_Medic_MTP","UK3CB_BAF_Medic_MTP_H"];
BTC_loop_check      = 1;
