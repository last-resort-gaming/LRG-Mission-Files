...
player addEventHandler ["Fired",{private ["_al_throwable"]; _al_throwable = _this select 6;[[[_al_throwable],"AL_roadflare\al_roadflare.sqf"],"BIS_fnc_execVM",true,true] spawn BIS_fnc_MP;}];