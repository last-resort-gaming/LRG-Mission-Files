...
BTC_who_can_revive  = ["B_medic_F","B_recon_medic_F","B_G_medic_F","O_medic_F","I_medic_F","O_recon_medic_f","CUP_B_BAF_Medic_MTP","UK3CB_BAF_Medic_MTP","UK3CB_BAF_Medic_MTP_H","UK3CB_BAF_HeliMedic_MTP_H"];
BTC_loop_check      = 1;
...
if (!isDedicated) then {
	...
	BTC_Medical_Trucks = ["B_Truck_01_medical_F","O_Truck_03_medical_F","I_Truck_02_medical_F","O_Truck_02_medical_F","Land_Pod_Heli_Transport_04_medevac_F","B_Slingload_01_Medevac_F","O_Heli_Transport_04_medevac_F"];
	BTC_Medical_Trucks_addActionText = "First Aid";		// addAction text displayed when reviving someone near medical truck
};	
