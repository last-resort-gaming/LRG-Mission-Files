...
force adv_aceCPR_onlyDoctors = 1;
...
dev_zombie_huntDistance = 100;
dev_zombie_infectionChance = 0.5;
dev_zombie_maxDistance = 500;
...
dev_asymhuman_attack_reachVeh = 6;
...
dev_asymhuman_stage2_attackDistanceVeh = 5.5;
...
dev_parasite_attackDistanceVeh = 5.5;
