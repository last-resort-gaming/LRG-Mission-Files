...
RadioRange = 2;							// Radio Range Multiplier. 2 = double radio range, 0.5 = half radio range, ect. DEFAULT: 1.5.
...
TFAR_ON_Message = False;						// Announce TFAR ON message. True to enable, false to disable. DEFAULT: True.
TFAR_Message_Time = 55;						// Time to TFAR ON message in Minutes. DEFAULT: 55mins.

EnableArsenal = False;						// Enable Default LRG 3CB Arsenal. True to enable, false to disable. DEFAULT: True.
...
TimedArsenal = False;						// Remove the Arsenal after 'ArsenalExpiry'. True to enable, false to disable. DEFAULT: True.
ArsenalExpiry = 50;							// How long in minutes from server start to remove the Arsenal. DEFAULT: 50mins

EnableAmmoBox = False;						// Enable Default LRG 3CB Section Ammo Boxes. Tue to enable, false to disable. DEFAULT: True.
...
Confirmation = True;						// Set to True once you've finished all these settings. DEFAULT: False.