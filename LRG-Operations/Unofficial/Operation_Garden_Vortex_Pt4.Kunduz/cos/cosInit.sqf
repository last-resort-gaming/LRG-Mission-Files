...
blackListTowns = ["Tal Gozar","Airport Road"];// Remove towns from COS

whiteListMkrs=["COS1","COS2","COS3","COS4"];// Add Custom Markers for COS to populate 
...
COScivPool =["CUP_C_C_Citizen_01","CUP_C_C_Citizen_02","CUP_C_C_Citizen_03","CUP_C_C_Citizen_04","CUP_C_C_Worker_01","CUP_C_C_Worker_02","CUP_C_C_Worker_03","CUP_C_C_Worker_04","CUP_C_C_Villager_01","CUP_C_C_Villager_02","CUP_C_C_Villager_03","CUP_C_C_Villager_04","CUP_C_C_Assistant_01","CUP_C_C_Worker_05","CUP_C_C_Mechanic_01"];	
COSmotPool =["CUP_C_LR_Transport_CTK","CUP_C_Octavia_CIV","CUP_C_UAZ_Unarmed_TK_CIV","CUP_C_Ural_Civ_01","CUP_C_Ural_Civ_02","CUP_C_Ural_Civ_03","CUP_C_Ural_Open_Civ_01","CUP_C_Datsun","CUP_C_Datsun_4seat","CUP_C_Golf4_white_Civ"];

COSmaxGrps=5;//Set Maximum group limit for COS at any one time (If limit is hit then civilians will be placed into a single group for each town)
