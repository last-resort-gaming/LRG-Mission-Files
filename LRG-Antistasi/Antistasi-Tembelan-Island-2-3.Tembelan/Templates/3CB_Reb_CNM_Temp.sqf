...
vehSDKLightArmed = "UK3CB_CCM_I_Hilux_Pkm";
...
//Starting Unlocks
initialRebelEquipment append ["rhs_weap_makarov_pm","rhs_weap_akm","rhs_weap_akmn","rhs_weap_rpg75"];
initialRebelEquipment append ["rhs_weap_rpg75", "rhs_ec75_sand_mag", "IEDLandSmall_Remote_Mag", "IEDUrbanSmall_Remote_Mag"];
initialRebelEquipment append ["rhs_mag_9x18_8_57N181S","rhs_30Rnd_762x39mm_bakelite", "rhs_30Rnd_762x39mm_bakelite_tracer","rhs_grenade_mkii_mag","rhs_grenade_mki_mag","rhs_mag_rdg2_black","rhs_grenade_m15_mag"];
