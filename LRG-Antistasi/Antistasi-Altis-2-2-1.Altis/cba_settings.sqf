...
force force ace_finger_indicatorColor = [1,0.5,0,1];
...
force force LRG_Main_FlipVehicle = true;
force force LRG_Main_FPSCounter = true;
force force LRG_Main_LockCamVehicle = false;
force force LRG_Main_Logging = false;
force force LRG_Main_PilotCheck = false;
force force LRG_Main_QSMagRepack = false;
force force LRG_Main_TFARTerrainInterference = 0.2;
force force LRG_Main_TFARTransmitRange = 3.5;
...
// LRG QS Icons
force force LRG_QS_ST_AINames = false;
force force LRG_QS_ST_colorInjured = [0.75,0.55,0,0.75];
force force LRG_QS_ST_enableGroupIcons = true;
force force LRG_QS_ST_gps_enableUnitIcons = true;
force force LRG_QS_ST_GPSDist = 300;
force force LRG_QS_ST_GPSshowGroupOnly = true;
force force LRG_QS_ST_GPSshowNames = false;
force force LRG_QS_ST_groupTextFactionOnly = true;
force force LRG_QS_ST_iconColor_CIVILIAN = [0.4,0,0.5,0.65];
force force LRG_QS_ST_iconColor_EAST = [0.5,0,0,0.65];
force force LRG_QS_ST_iconColor_RESISTANCE = [0,0.5,0,0.65];
force force LRG_QS_ST_iconColor_UNKNOWN = [0.7,0.6,0,0.5];
force force LRG_QS_ST_iconColor_WEST = [0,0.3,0.6,0.65];
force force LRG_QS_ST_iconMapText = true;
force force LRG_QS_ST_iconTextFonts = 5;
force force LRG_QS_ST_iconUpdatePulseDelay = 60;
force force LRG_QS_ST_map_enableUnitIcons = true;
force force LRG_QS_ST_MasterEnable = true;
force force LRG_QS_ST_MedicalIconColor = [1,0.41,0,1];
force force LRG_QS_ST_MedicalSystem = 0;
force force LRG_QS_ST_showAI = false;
force force LRG_QS_ST_showAIGroups = false;
force force LRG_QS_ST_showAINames = false;
force force LRG_QS_ST_showCivilianIcons = false;
force force LRG_QS_ST_showFactionOnly = true;
force force LRG_QS_ST_showGroupHudIcons = false;
force force LRG_QS_ST_showGroupMapIcons = false;
force force LRG_QS_ST_showGroupOnly = true;
force force LRG_QS_ST_showMedicalWounded = true;
force force LRG_QS_ST_showMOS = true;
force force LRG_QS_ST_showMOS_range = 3500;
force force LRG_QS_ST_showOwnGroup = false;

// LRG Weather
force force LRG_Weather_DayTimeAcc = 1;
force force LRG_Weather_Master = false;
force force LRG_Weather_MaxTime = 60;
force force LRG_Weather_MinTime = 30;
force force LRG_Weather_NightTimeAcc = 3;
