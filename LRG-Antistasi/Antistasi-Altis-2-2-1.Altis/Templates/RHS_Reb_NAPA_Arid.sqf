...
//Starting Unlocks
initialRebelEquipment append ["rhs_weap_type94_new","rhs_weap_tt33","rhs_weap_Izh18","rhs_weap_kar98k","rhs_weap_m38","rhs_weap_m38_rail","rhs_weap_m1garand_sa43","rhs_weap_m92"];
initialRebelEquipment append ["rhs_weap_rpg75"];
initialRebelEquipment append ["rhs_mag_6x8mm_mhp","rhs_mag_762x25_8","rhsgref_1Rnd_00Buck","rhsgref_1Rnd_Slug","rhsgref_5Rnd_792x57_kar98k","rhs_grenade_mkii_mag","rhs_grenade_mki_mag","rhs_mag_rdg2_black","rhs_grenade_m15_mag","rhsgref_8Rnd_762x63_M2B_M1rifle","rhsgref_5Rnd_762x54_m38","rhs_30Rnd_762x39mm"];
...
//TAFR Unlocks
if (hasTFAR) then {initialRebelEquipment append ["tf_microdagr","tf_anprc148jem"]};
