...
savingServer = false;
_saveHintText = format ["%1 fund count:<br/>HR: %2<br/>Money: %3 €",nameTeamPlayer,_hrBackground,_resourcesBackground];
[petros,"hint",_saveHintText, "Save Complete"] remoteExec ["A3A_fnc_commsMP", 0];
