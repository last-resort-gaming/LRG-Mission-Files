...
staticATBuenos = "LIB_ger_Pak40_Feldgrau";
staticAABuenos = "LIB_ger_Flak30_Camo";
...
vehSDKLightUnarmed = "LIB_USA_Willys_MB";
vehSDKTruck = "LIB_pol_opelblitz_open_Tarn_Czata";
...
civTruck = "LIB_pol_opelblitz_open_Tarn_Czata";
