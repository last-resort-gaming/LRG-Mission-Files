...
params ["_buildingObject", "_vehicleType"];
...
if (_player distance _buildingObject > 20) exitWith 
{
...
[_player, _buildingObject, _vehicleType] call para_s_fnc_bf_veh_spawn_create_vehicle;