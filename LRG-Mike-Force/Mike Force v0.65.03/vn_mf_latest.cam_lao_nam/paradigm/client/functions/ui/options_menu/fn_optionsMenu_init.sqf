...
private _controls = [];
{
	...
	switch (toLower _type) do {
		case "checkbox": {
			...
			_ctrlCheckbox setVariable ["#data", [_name, _varname, _type, _default, _value, _ctrlName, _ctrlBackground, _ctrlGroup]];
		...
		case "slider": {
			...
			_ctrlSlider setVariable ["#data", [_name, _varname, _type, _default, _value, _ctrlName, _ctrlBackground, _ctrlGroup, _ctrlValue]];
		...
		case "combobox": {
			...
			_ctrlCombo setVariable ["#data", [_name, _varname, _type, _default, _value, _ctrlName, _ctrlBackground, _ctrlGroup, _values]];
